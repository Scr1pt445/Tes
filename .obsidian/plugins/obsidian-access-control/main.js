...
async function logEvent(app, action, user, details) {
  const path = "events.json";
  let eventsJson;
  const file = app.vault.getAbstractFileByPath(path);
  if (file instanceof import_obsidian.TFile) {
    const content = await app.vault.read(file);
    eventsJson = JSON.parse(content);
  } else {
    eventsJson = { events: [] };
  }
  ...
  if (eventsJson.events.length > 1e3) {
    eventsJson.events = eventsJson.events.slice(-1e3);
  }
  await safeCreateOrUpdateFile(app, path, JSON.stringify(eventsJson, null, 2));
}
...
var SetupAdminModal = class extends import_obsidian3.Modal {
  ...
  onOpen() {
    ...
    const leftCol = wrapper.createDiv({
      attr: {
        style: `
          display: flex;
  ...
  async render() {
    ...
    if (!this.tokenValidated) {
      ...
      submitBtn.onclick = async () => {
        ...
        await logEvent(this.app, "\u0412\u0445\u043E\u0434 \u0432 \u0430\u0434\u043C\u0438\u043D-\u043F\u0430\u043D\u0435\u043B\u044C", current.email);
        this.render();
      };
      return;
    }
    ...
    new import_obsidian5.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u0412\u044B\u0439\u0442\u0438").setWarning().onClick(async () => {
        await logEvent(this.app, "\u0412\u044B\u0445\u043E\u0434 \u0438\u0437 \u0441\u0438\u0441\u0442\u0435\u043C\u044B", current.email);
    ...
    access.users.forEach((u) => {
      ...
      new import_obsidian5.Setting(usersBox).setClass("access-admin-user-row").addText((t) => {
        ...
        t.onChange(async (v) => {
          u.password = v;
          await this.plugin.saveAccessJson(access);
          await logEvent(this.app, `\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u0435 \u043F\u0430\u0440\u043E\u043B\u044F`, current.email, `\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C: ${u.email}`);
        ...
        dd.onChange(async (v) => {
          u.role = v;
          await this.plugin.saveAccessJson(access);
          await logEvent(this.app, `\u0418\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0435 \u0440\u043E\u043B\u0438`, current.email, `\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C: ${u.email}, \u041D\u043E\u0432\u0430\u044F \u0440\u043E\u043B\u044C: ${v}`);
        ...
        (btn) => btn.setIcon("trash").setWarning().onClick(async () => {
          ...
          await this.plugin.saveAccessJson(access);
          await logEvent(this.app, `\u0423\u0434\u0430\u043B\u0435\u043D\u0438\u0435 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F`, current.email, `\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C: ${u.email}`);
    ...
    new import_obsidian5.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F").setCta().onClick(async () => {
        ...
        await this.plugin.saveAccessJson(access);
        await logEvent(this.app, `\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F`, current.email, `\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C: ${newEmail}, \u0420\u043E\u043B\u044C: ${newRole}`);
    ...
    access.groups.forEach((group) => {
      ...
      access.users.forEach((u) => {
        ...
        cb.onchange = async () => {
          ...
          await this.plugin.saveAccessJson(access);
          await logEvent(this.app, `\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u0435 \u0433\u0440\u0443\u043F\u043F\u044B`, current.email, `\u0413\u0440\u0443\u043F\u043F\u0430: ${group.name}, \u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C: ${u.email}, \u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435: ${cb.checked ? "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D" : "\u0423\u0434\u0430\u043B\u0451\u043D"}`);
      ...
      new import_obsidian5.Setting(box).addButton(
        (b) => b.setButtonText("\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443").setWarning().onClick(async () => {
          ...
          await this.plugin.saveAccessJson(access);
          await logEvent(this.app, `\u0423\u0434\u0430\u043B\u0435\u043D\u0438\u0435 \u0433\u0440\u0443\u043F\u043F\u044B`, current.email, `\u0413\u0440\u0443\u043F\u043F\u0430: ${group.name}`);
    ...
    new import_obsidian5.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443").setCta().onClick(async () => {
        ...
        await this.plugin.saveAccessJson(access);
        await logEvent(this.app, `\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u0433\u0440\u0443\u043F\u043F\u044B`, current.email, `\u0413\u0440\u0443\u043F\u043F\u0430: ${newGroupName}`);
  ...
  nodes.forEach((node) => {
    ...
    if (node.type === "folder") {
      ...
      select.onchange = async () => {
        ...
        await logEvent(plugin.app, `\u0418\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0435 \u043F\u0440\u0430\u0432`, current.email, `\u0413\u0440\u0443\u043F\u043F\u0430: ${group.name}, \u041F\u0443\u0442\u044C: ${node.path}, \u041F\u0440\u0430\u0432\u0430: ${value}`);
...
var LogModal = class extends import_obsidian7.Modal {
  ...
  async onOpen() {
    ...
    containerEl.style.color = "#fff";
    containerEl.style.maxWidth = "700px";
    containerEl.style.margin = "auto";
    containerEl.style.position = "fixed";
    containerEl.style.left = "50%";
    containerEl.style.top = "50%";
    ...
    style.textContent = `
      ...
      .log-entry span.action {
        color: #ffc89f;
      }
      .log-entry span.details {
        color: #fff8;
      }
      .log-no-events {
        color: #888;
    ...
    const wrapper = containerEl.createDiv({ cls: "log-wrapper" });
    const leftCol = wrapper.createDiv({ cls: "log-left" });
    leftCol.createEl("h2", { text: "\u0416\u0443\u0440\u043D\u0430\u043B \u0441\u043E\u0431\u044B\u0442\u0438\u0439 (\u043B\u043E\u0433)" });
    let filter = "";
    new import_obsidian7.Setting(leftCol).setName("\u0424\u0438\u043B\u044C\u0442\u0440 \u043F\u043E email \u0438\u043B\u0438 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044E").addText(
      (t) => t.setPlaceholder("user@, action...").onChange((v) => {
        filter = v.trim().toLowerCase();
        renderList();
      })
    );
    const logBox = wrapper.createDiv({ cls: "log-right" });
    const renderList = () => {
      logBox.empty();
      let shown = 0;
      events.events.slice().reverse().filter(
        ...
        shown++;
        const line = logBox.createDiv({ cls: "log-entry" });
        line.createSpan({ text: `${new Date(e.timestamp).toLocaleString()} | `, cls: "timestamp" });
        line.createSpan({ text: `[${e.user ?? "-"}] `, cls: "user" });
        line.createSpan({ text: e.action, cls: "action" });
        if (e.details) {
          line.createSpan({ text: ` \u2014 ${e.details}`, cls: "details" });
        }
      });
      if (shown === 0) {
        logBox.createDiv({ text: "\u041D\u0435\u0442 \u0441\u043E\u0431\u044B\u0442\u0438\u0439 \u0434\u043B\u044F \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F.", cls: "log-no-events" });
      }
    };
    renderList();
  }
